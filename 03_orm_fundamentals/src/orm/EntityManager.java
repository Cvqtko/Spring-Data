...
public class EntityManager<E> implements DbContext<E> {
	...
	public Iterable<E> find(Class<E> table) throws InvocationTargetException, SQLException, InstantiationException,
	...
	public Iterable<E> find(Class<E> table, String where) throws SQLException, NoSuchMethodException,
		...
		String query = "SELECT * FROM " + table.getAnnotation(Entity.class).name() + " WHERE 1 "
	...
	public E findFirst(Class<E> table) throws InvocationTargetException, SQLException, InstantiationException,
			IllegalAccessException, NoSuchMethodException {
		return this.findFirst(table, null);
	}

	public E findFirst(Class<E> table, String where) throws SQLException, NoSuchMethodException, IllegalAccessException,
	...
	private void fillField(Field field, Object instance, ResultSet set, String fieldName)
